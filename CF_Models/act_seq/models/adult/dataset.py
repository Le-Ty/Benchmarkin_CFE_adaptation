...
from CF_Models.act_seq.common.paths import ADULT_DIR
...
class AdultDataset(object):
    ...
    def prep(cls, filename, feature_spec):
        ...
        feature_stats = cls.get_feature_stats(train_xs,
                                              feature_spec)  # Normalize wrt train data to prevent data leak, per X suggestion
