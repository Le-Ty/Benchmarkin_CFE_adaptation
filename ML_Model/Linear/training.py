...
import ML_Model.Linear.model as model
...
def training(model, train_loader, test_loader, learning_rate, epochs, dataset):
    ...
    torch.save(model.state_dict(),
               '../Saved_Models/Linear/{}_{}_input_{}_lr_{}_te_{:.2f}.pt'.format(timestamp, dataset,
                                                                                 model.input_neurons,
...
model = model.Linear(input_size, 1)
...
# training(model, trainloader, testloader, 0.001, 100, 'adult')
